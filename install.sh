...
sudo pacman -Syu
sudo pacman -S i3-wm i3status xorg-server xorg-xinit dmenu picom feh maim xorg-xrandr bluez bluez-utils pulsemixer xorg-xinput fish rxvt-unicode fastfetch starship htop xclip nvim cmake mingw-w64 valgrind dotnet-runtime dotnet-sdk jdk-openjdk php mysql-workbench sdl2_image sdl2_mixer sdl2_ttf sdl2_net mosh nemo nemo-fileroller libreoffice-fresh gimp inkscape audacity discord wine noto-fonts-emoji steam jdk17-openjdk spotify-launcher
