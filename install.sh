...
yay -S autotiling picom-ftlabs-git google-chrome minecraft-launcher oracle-instantclient-sqlplus onlyoffice-bin mingw-w64-cmake mingw-w64-sdl2 mingw-w64-sdl2_image mingw-w64-sdl2_mixer mingw-w64-sdl2_ttf
